...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "foo@example.com:hello", "bar@example.com:world", "h:h"
    };
    /**
...
//        getSupportActionBar().hide();
     ...
     */
    public void cargarDatos(String user, String pass) {
        boolean verif;
        final String usuario = user;
        // Añadir parámetro a la URL del web service
        //String newURL = VariablesURL.GET_LOGIN2 + user + "&password=" + pass + "&imei=" + im;
        String newURL = VariablesURL.GET_LOGIN + user + "&password=" + pass;
    ...
    private void procesarRespuesta(JSONObject response) {
        ...
        Log.i("DATOS===============> ", usuario_guardar.getId());

        values1.put("id", usuario_guardar.getId());
        values1.put("nombres", usuario_guardar.getNombres());
        values1.put("ap_paterno", usuario_guardar.getAp_paterno());
        values1.put("ap_materno", usuario_guardar.getAp_materno());
        values1.put("estilo", usuario_guardar.getEstilo());
        values1.put("nivel", usuario_guardar.getNivel());
        System.out.println("NIVEL: "+usuario_guardar.getNivel());
        db.insert("users", null, values1);

        db.close();

        if (usuario_guardar.getNivel().equals("0")) {
            Intent i = new Intent(LoginActivity.this, Cuestionario.class);
            i.putExtra("id",usuario_guardar.getId());
            i.putExtra("user",usuario_guardar.getUser());
            finish();
            startActivity(i);
        } else {
